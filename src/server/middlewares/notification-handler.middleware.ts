...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'car.create': { roles: ['owner', 'admin'], key: 'car-added', tenantPath: ['company', 'car'], userPath: [] },
  'car.update': { roles: ['owner', 'admin'], key: 'car-updated', tenantPath: ['company', 'car'], userPath: [] },
  'car.delete': { roles: ['owner', 'admin'], key: 'car-deleted', tenantPath: ['company', 'car'], userPath: [] },
  'booking.create': {
